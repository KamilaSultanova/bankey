...
extension AccountSummaryCell {
    private func setup() {
        ...
        balanceAmountLabel.attributedText = makeFormattedBalance(dollars: "967,457", cents: "78")
    ...
    private func layout() {
        NSLayoutConstraint.activate([
            ...
            imageview.topAnchor.constraint(equalToSystemSpacingBelow: underLineView.bottomAnchor, multiplier: 1),
